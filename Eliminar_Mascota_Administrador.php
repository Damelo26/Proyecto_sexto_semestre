...
include "Configuraciones/Funciones.php";
    ...
    $Query_Eliminar= mysqli_query($conexion, "SELECT m.ID_Mascota, C.Nombre as Categoria, m.Nombre_Mascota as Nombre, m.Raza, m.Edad, Cl.Nombre as Color, T.Nombre as Tamano, m.Frase, m.Peso, Es.Estado as Estado FROM mascotas m INNER JOIN categoria_mascota C ON m.ID_Categoria = C.ID_Categoria INNER JOIN color Cl ON m.ID_Color = Cl.ID_Color INNER JOIN tamano T ON m.ID_Tamano = T.ID_Tamano INNER JOIN estado Es ON m.ID_Estado = Es.ID_Estado WHERE m.ID_Mascota = $ID_Eliminar");
